export type AddonKind = "skill" | "plugin" | "connector";
...
export const LIBRARY_KEY = "helix-library-v1";
...
export function allAddons(custom: Addon[] = []): Addon[] {
