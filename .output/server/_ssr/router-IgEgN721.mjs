...
//#region node_modules/.nitro/vite/services/ssr/assets/router-IgEgN721.js
...
var styles_default = "/assets/styles-YEYgAVV6.css";
...
var $$splitComponentImporter = () => import("./routes-CgkPjziT.mjs");
...
function deskPreamble(selfId, providerId, roster, addons) {
...
${formatRoster(roster)}${addons?.skills?.length ? `\nEnabled skills for this session: ${addons.skills.join(", ")}.` : ""}${addons?.connectors?.length ? `\nEnabled connectors for this session: ${addons.connectors.join(", ")}.` : ""}
...
//#endregion
export { PROVIDERS_KEY as a, resolveProvider as c, projectById as i, deskPreamble as n, PROVIDER_ORDER as o, formatRoster as r, allProviders as s, router_exports as t };
